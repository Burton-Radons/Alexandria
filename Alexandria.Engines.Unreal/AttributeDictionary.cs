...
namespace Alexandria.Engines.Unreal {
    ...
    public class AttributeDictionary : Dictionary<string, object> {
		/// <summary>
		/// Load an <see cref="AttributeDictionary"/> from the <see cref="Package"/> and the <see cref="Reader"/>.
		/// </summary>
		/// <param name="package">The <see cref="Package"/> the dictionary is in.</param>
		/// <param name="reader">The <see cref="Reader"/> that holds the dictionary's data.</param>
