...
namespace Alexandria.Engines.DarkSouls {
	partial class TableRows {
		...
		/// </remarks>
		public class WeaponUpgrade : ParameterTableRow {
			...
			public static readonly PropertyInfo
				PhysicsAtkRateProperty = GetProperty<WeaponUpgrade>("PhysicsAtkRate"),
				MagicAtkRateProperty = GetProperty<WeaponUpgrade>("MagicAtkRate"),
				FireAtkRateProperty = GetProperty<WeaponUpgrade>("FireAtkRate"),
				ThunderAtkRateProperty = GetProperty<WeaponUpgrade>("ThunderAtkRate"),
				StaminaAtkRateProperty = GetProperty<WeaponUpgrade>("StaminaAtkRate"),
				SaWeaponAtkRateProperty = GetProperty<WeaponUpgrade>("SaWeaponAtkRate"),
				SaDurabilityRateProperty = GetProperty<WeaponUpgrade>("SaDurabilityRate"),
				CorrectStrengthRateProperty = GetProperty<WeaponUpgrade>("CorrectStrengthRate"),
				CorrectAgilityRateProperty = GetProperty<WeaponUpgrade>("CorrectAgilityRate"),
				CorrectMagicRateProperty = GetProperty<WeaponUpgrade>("CorrectMagicRate"),
				CorrectFaithRateProperty = GetProperty<WeaponUpgrade>("CorrectFaithRate"),
				PhysicsGuardCutRateProperty = GetProperty<WeaponUpgrade>("PhysicsGuardCutRate"),
				MagicGuardCutRateProperty = GetProperty<WeaponUpgrade>("MagicGuardCutRate"),
				FireGuardCutRateProperty = GetProperty<WeaponUpgrade>("FireGuardCutRate"),
				ThunderGuardCutRateProperty = GetProperty<WeaponUpgrade>("ThunderGuardCutRate"),
				PoisonGuardResistRateProperty = GetProperty<WeaponUpgrade>("PoisonGuardResistRate"),
				DiseaseGuardResistRateProperty = GetProperty<WeaponUpgrade>("DiseaseGuardResistRate"),
				BloodGuardResistRateProperty = GetProperty<WeaponUpgrade>("BloodGuardResistRate"),
				CurseGuardResistRateProperty = GetProperty<WeaponUpgrade>("CurseGuardResistRate"),
				StaminaGuardDefRateProperty = GetProperty<WeaponUpgrade>("StaminaGuardDefRate"),
				SpEffectId1Property = GetProperty<WeaponUpgrade>("SpEffectId1"),
				SpEffectId2Property = GetProperty<WeaponUpgrade>("SpEffectId2"),
				SpEffectId3Property = GetProperty<WeaponUpgrade>("SpEffectId3"),
				ResidentSpEffectId1Property = GetProperty<WeaponUpgrade>("ResidentSpEffectId1"),
				ResidentSpEffectId2Property = GetProperty<WeaponUpgrade>("ResidentSpEffectId2"),
				ResidentSpEffectId3Property = GetProperty<WeaponUpgrade>("ResidentSpEffectId3"),
				MaterialSetIdProperty = GetProperty<WeaponUpgrade>("MaterialSetId"),
				PadProperty = GetProperty<WeaponUpgrade>("Pad");
			...
			/// </remarks>
			[ParameterTableRowAttribute("physicsAtkRate", index: 0, minimum: 0, maximum: 99.99, step: 0.01, order: 100, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("magicAtkRate", index: 1, minimum: 0, maximum: 99.99, step: 0.01, order: 200, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("fireAtkRate", index: 2, minimum: 0, maximum: 99.99, step: 0.01, order: 300, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("thunderAtkRate", index: 3, minimum: 0, maximum: 99.99, step: 0.01, order: 400, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("staminaAtkRate", index: 4, minimum: 0, maximum: 99.99, step: 0.01, order: 500, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("saWeaponAtkRate", index: 5, minimum: 0, maximum: 99.99, step: 0.01, order: 600, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("saDurabilityRate", index: 6, minimum: 0, maximum: 99.99, step: 0.01, order: 700, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("correctStrengthRate", index: 7, minimum: 0, maximum: 99.99, step: 0.01, order: 800, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("correctAgilityRate", index: 8, minimum: 0, maximum: 99.99, step: 0.01, order: 900, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("correctMagicRate", index: 9, minimum: 0, maximum: 99.99, step: 0.01, order: 1000, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("correctFaithRate", index: 10, minimum: 0, maximum: 99.99, step: 0.01, order: 1100, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("physicsGuardCutRate", index: 11, minimum: 0, maximum: 99.99, step: 0.01, order: 1200, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("magicGuardCutRate", index: 12, minimum: 0, maximum: 99.99, step: 0.01, order: 1300, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("fireGuardCutRate", index: 13, minimum: 0, maximum: 99.99, step: 0.01, order: 1400, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("thunderGuardCutRate", index: 14, minimum: 0, maximum: 99.99, step: 0.01, order: 1500, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("poisonGuardResistRate", index: 15, minimum: 0, maximum: 99.99, step: 0.01, order: 1600, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("diseaseGuardResistRate", index: 16, minimum: 0, maximum: 99.99, step: 0.01, order: 1700, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("bloodGuardResistRate", index: 17, minimum: 0, maximum: 99.99, step: 0.01, order: 1800, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("curseGuardResistRate", index: 18, minimum: 0, maximum: 99.99, step: 0.01, order: 1900, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("staminaGuardDefRate", index: 19, minimum: 0, maximum: 99.99, step: 0.01, order: 2000, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("spEffectId1", index: 20, minimum: 0, maximum: 255, step: 1, order: 2100, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("spEffectId2", index: 21, minimum: 0, maximum: 255, step: 1, order: 2200, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("spEffectId3", index: 22, minimum: 0, maximum: 255, step: 1, order: 2300, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("residentSpEffectId1", index: 23, minimum: 0, maximum: 255, step: 1, order: 2400, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("residentSpEffectId2", index: 24, minimum: 0, maximum: 255, step: 1, order: 2500, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("residentSpEffectId3", index: 25, minimum: 0, maximum: 255, step: 1, order: 2600, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("materialSetId", index: 26, minimum: 0, maximum: 255, step: 1, order: 2700, unknown2: 1)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("pad[9]", index: 27, minimum: 0, maximum: 0, step: 0, order: 2701, unknown2: 0)]
			[DisplayName("pading")]
			[Description("")]
			[Browsable(false)]
			public Byte[] Pad {
			...
			internal WeaponUpgrade(ParameterTable table, int index, AssetLoader loader, int next)
			...
			internal WeaponUpgrade(ParameterTable table, int index)
				: base(table, index) {
