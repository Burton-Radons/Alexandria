...
namespace Alexandria.Engines.DarkSouls {
	partial class TableRows {
		...
		public class Shadow : ParameterTableRow {
			...
			/// </remarks>
			[ParameterTableRowAttribute("densityRatio", index: 2, minimum: 0, maximum: 100, step: 1, order: 3, unknown2: 0)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("colR", index: 3, minimum: 0, maximum: 255, step: 1, order: 4, unknown2: 0)]
			[DisplayName("Color R")]
			[Description("0-255")]
			[DefaultValue((Int16)0)]
			public Int16 ColR {
			...
			/// Japanese description: "0～255", Google translated: "0-255".
			/// </remarks>
			[ParameterTableRowAttribute("colG", index: 4, minimum: 0, maximum: 255, step: 1, order: 5, unknown2: 0)]
			[DisplayName("Color G")]
			[Description("0-255")]
			[DefaultValue((Int16)0)]
			public Int16 ColG {
			...
			/// Japanese description: "0～255", Google translated: "0-255".
			/// </remarks>
			[ParameterTableRowAttribute("colB", index: 5, minimum: 0, maximum: 255, step: 1, order: 6, unknown2: 0)]
			[DisplayName("Color B")]
			[Description("0-255")]
			[DefaultValue((Int16)0)]
			public Int16 ColB {
			...
			/// </remarks>
			[ParameterTableRowAttribute("beginDist", index: 6, minimum: 0, maximum: 99999, step: 0.1, order: 7, unknown2: 0)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("endDist", index: 7, minimum: 0, maximum: 99999, step: 0.1, order: 8, unknown2: 0)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("calibulateFar", index: 8, minimum: 0, maximum: 99999, step: 0.1, order: 9, unknown2: 0)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("fadeBeginDist", index: 9, minimum: 0, maximum: 99999, step: 0.1, order: 10, unknown2: 0)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("fadeDist", index: 10, minimum: -1, maximum: 99999, step: 0.1, order: 11, unknown2: 0)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("persedDepthOffset", index: 11, minimum: -1, maximum: 1, step: 0.0001, order: 12, unknown2: 0)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("ｇradFactor", index: 12, minimum: -3, maximum: 5, step: 0.01, order: 13, unknown2: 0)]
			[DisplayName("")]
			[Description("")]
			[DefaultValue((Single)0)]
			...
			/// </remarks>
			[ParameterTableRowAttribute("shadowVolumeDepth", index: 13, minimum: 1, maximum: 9999, step: 0.1, order: 14, unknown2: 0)]
